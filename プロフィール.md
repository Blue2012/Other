...
## ■2022年
## 【１】某特別民間法人向けSharePoint Online導入
### ■概要

## 【２】某政策金融機関向け仮想分離ブラウザシステム導入
### ■概要

## 【３】某損害保険会社様向けMicrosoft Graphスクリプト改修
### ■概要

## 【４】某私立大学向けMicrosoft365ライセンス変更/Microsoft Graphスクリプト改修
### ■概要
...
NTTが担当した大学側に設置するCisco Merakiの設定に誤りがあり、再設定が必要となったため、プロジェクト期間が伸びに伸びたことも印象深い。
...
親会社が大きな会社となっており、そちらの管理ポリシーを踏襲しつつ、自分たちの会社のオリジナルの設計を実施するという要件をいただいていた。   
...
### ■概要
Office365の認証をオンプレミスのActive Directoryアカウントで認証するための基盤を導入する案件。   
